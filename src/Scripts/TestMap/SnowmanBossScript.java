...
public class SnowmanBossScript extends Script {
    protected Enemy treeBoss = new Enemy("SnowmanBoss", 150, 5, 2, "EvilSnowmanSprite.png", 100, 100);
    int npcId = 4;
    ...
    public ArrayList<ScriptAction> loadScriptActions() {
        ...
        scriptActions.add(new IsEnemyDefeatedScript(treeBoss, "snowmanBossDefeated"));
