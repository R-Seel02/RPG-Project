...
public class MuggedWoman extends NPC {
    //private int totalAmountMoved = 0;
    private Direction direction = Direction.RIGHT;
    //private float speed = 1;
    
    public MuggedWoman(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("MuggedWoman.png"), 30, 30), "STAND_RIGHT");
    }
